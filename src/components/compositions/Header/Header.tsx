...
export function Header() {
	...
	return (
		<header className="fixed top-2 left-2 shadow-md rounded-md flex flex-row divide-x border border-gray-100 dark:border-gray-700 bg-white dark:bg-slate-950 dark:shadow-neutral-800 z-50">
